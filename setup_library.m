...
Params.username     = 'wanglei19970922';                                        % Input your WRDS username
Params.pass         = 'Wanglei19970922@';                                        % Input your WRDS password
Params.SAMPLE_START = 1999;                                                % Sample start year
Params.SAMPLE_END   = 2023;                                                % Sample end year
Params.domComEqFlag = true;                                                % Flag for domestic common equity (true => use only share code 10 or 11)
