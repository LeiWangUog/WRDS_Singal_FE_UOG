...
if fileName~=0
    ...
    % Do this manually
    signalInfo.Authors       = 'lei ';
    signalInfo.email         = '2849636W@student.gla.ac.uk';
    signalInfo.PaperTitle    = 'Assaying Anomalies';
    signalInfo.SignalName    = 'Forcast error singal';
    signalInfo.SignalAcronym = 'FES';
    signalInfo.fileLink      = 'signal_matrix_CI.csv';
end
